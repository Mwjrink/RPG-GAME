...
public class Earpe1 extends Creature {
	...
	public Earpe1(float x, float y, int width, int height) {
		...
		animDown = new Animation((4), Assets.getNpc1Down());
		animUp = new Animation((4), Assets.getNpc1Up());
		animRight = new Animation((4), Assets.getNpc1Right());
		animLeft = new Animation((4), Assets.getNpc1Left());
	}
	...
	@Override
	String getText(){
		return "0 Hello, My name is Marshall Virgil Earp";
	...
	public String getText(int i) {
		switch (i) {
			case 0:
				return "0 My name is Marshall Virgil Earp, and you need to return to prison Daltons";
			case 1:
				return "0 BANG! BANG! BANG! BANG! BANG! BANG! BANG! BANG!";
			default:
				return "0 Hello, My name is Marshall Virgil Earp";
		}
	}
	...
	public boolean animation(int anim){
		...
		xMotion = 0;
		yMotion = 0;
//		if(x > (Handler.getCamera().getxOffset()+Handler.getW()) || (x < Handler.getCamera().getxOffset())){
//				return false;
//			}
//		if(y > (Handler.getCamera().getyOffset()+Handler.getH()) || (y < Handler.getCamera().getyOffset())){
//			return false;
//		}
		switch(anim){
		case 1:
		...
		case 2:
//			System.out.println("Anim state 2 in the slimy, snitchy, sneaky and and shifty classes(move straight down then earpes?)");
			Handler.setShiftyAnim(true);
	...
	public boolean goToSweatyPost(){
		...
		if(y < 23*Handler.getTilewidth()){
			...
			moveY();
			return true;
		} else if (x < 45*Handler.getTilewidth()) {
			xMotion += 5;
			moveX();
			return true;
		}
	...
	public boolean enterSweatyPost(){
		if (x < 46*Handler.getTilewidth() && gg) {
			xMotion += 5;
			moveX();
			return true;
