...
public class Earpe2 extends Creature {
	...
	public Earpe2(float x, float y, int width, int height) {
		...
		animDown = new Animation((4), Assets.getNpc2Down());
		animUp = new Animation((4), Assets.getNpc2Up());
		animRight = new Animation((4), Assets.getNpc2Right());
		animLeft = new Animation((4), Assets.getNpc2Left());
	}
	...
	@Override
	String getText(){
		return "0 Hello, My name is Wyatt Earp";
