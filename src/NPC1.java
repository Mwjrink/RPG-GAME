...
public class NPC1 extends Creature {
	...
	public NPC1(float x, float y, int width, int height) {
	...
	@Override
	String getText(){
		return "0 NOOOOO!!!, now theres no one to protect the town from The Great Bujak and his NOBLINS to the south. OH it's hopeless!! Everyone HIDE!!!";
		
	}

	@Override
	public String getText(int i) {
		return "0 WOW! I am impressed, but The Great Bujak to the south is just too strong for anyone...";
	}
